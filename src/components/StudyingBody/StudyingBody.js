  ...
  return (
    <div className="study_body">
      ...
      >
        ...
        <TabPanel>
          <StudySecond
            courseText="В рамках данной темы рассматривается технология проведения анализа показателей финансовой эффективности с помощью модуля «Финансовый анализ» в ПАНЕЛИ УПРАВЛЕНИЯ"
