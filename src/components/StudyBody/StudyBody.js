  ...
  return (
    <div className="study_body">
      ...
      <Tabs defaultIndex={0} className="react-tabs firstTestsTabs">
        ...
        <TabPanel>
          <StudySecond courseText="В рамках данного курса Вы освоите навык построения финансовых моделей и научитесь определять наиболее выгодные для себя решения в важных финансовых ситуациях, используя модуль «Финансовое моделирование» в ПАНЕЛИ УПРАВЛЕНИЯ " />
        </TabPanel>
      </Tabs>
    </div>
  );
