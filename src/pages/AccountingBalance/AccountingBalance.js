...
import AccountingBalanceBody from "../../components/AccountingBalanceBody/AccountingBalanceBody";
...
function AccountingBalance(props) {
  const months = [
    {
      id: 1,
      title: "ЯНВ",
  ...
  return (
    <>
      ...
      <div className={styles.sitebody}>
        <Accountingleftnav />
        <AccountingBalanceBody months={months} />
        <InlineCalendar calendarVis="hidden" />
      </div>
    </>
  );
}
